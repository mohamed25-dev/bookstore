                        ...
                        @foreach($items as $item)
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <form style="float:left; margin: auto 5px" method="post" action="{{ route('cart.removeAll', $item->id) }}">
                                            @csrf
                                            <button class="btn btn-danger btn-sm" type="submit">أزل الكل</button>
                                        </form>

                                        <form style="float:left; margin: auto 5px" method="post" action="{{ route('cart.removeOne', $item->id) }}">
                                            @csrf
